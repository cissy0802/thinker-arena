...
{"summary": "综述(中文，约 150–250 字)：务必『先共识、后分歧』——开头先点出这场最大的共识/共同点(往往最值得带走)，再讲分歧的真正焦点。不要一上来就强调歧义。**但别用固定套话起手**——尤其别每次都以『全场最大的共识是…』『本场最坚实的共识在于…』这类同一副模子开篇；直接把那条共识的内容说出来即可，每场换个不同的进入方式",
