...
SCALARS = ["人数","轮数","每轮帖数","钩子数","钩子分布","钩子作者类型","钩子带答案表","选角语气收尾","选角代词起手","选角长度离散","二轮全反一轮","二轮同轮追击","二轮点名起手","二轮火力散布","轮内照抄顺序","首轮全独白","开场先字起手","帖尾问句","答案表位次","钩子问号收尾","副标题问号收尾","开场帖类别","收尾帖类别","末帖动作收尾","首轮序=选角序","末轮断连","末轮认错起手","末轮三条式","对偶否定句","表态档集合",
           "用了疑惑","表态覆盖率","带glossary帖数","术语轮次分布","术语加粗","加粗压帖尾","古文帖数","建议点名援引","建议带①②③","帖均加粗处","加粗处分布","总结膨胀比","总结数数起手","总结列清单","总结转日常","收尾建议条数","建议编号体例","建议时间锚","建议加粗起手","insight报幕式","insight全景起手","同场起手撞车","同场起手撞车(去水)"]
flags = []
