...
SCALARS = ["人数","轮数","每轮帖数","钩子数","钩子分布","钩子作者类型","钩子带答案表","选角语气收尾","选角代词起手","选角长度离散","二轮全反一轮","二轮同轮追击","二轮点名起手","二轮火力散布","轮内照抄顺序","首轮全独白","开场先字起手","帖尾问句","答案表位次","钩子问号收尾","副标题问号收尾","开场帖类别","收尾帖类别","首轮序=选角序","末轮断连","末轮认错起手","末轮三条式","对偶否定句","表态档集合",
